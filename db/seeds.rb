User.create!([
  {email: "droidmaxxx@gmail.com", encrypted_password: "$2a$11$o6cK8mUmssuhKz68WQeZh.bbtfpHJxw2DVyyNEa7734Fh35hBwERq", reset_password_token: nil, reset_password_sent_at: nil, remember_created_at: nil, sign_in_count: 1, current_sign_in_at: "2017-07-18 07:09:48", last_sign_in_at: "2017-07-18 07:09:48", current_sign_in_ip: "127.0.0.1", last_sign_in_ip: "127.0.0.1", is_active: true, is_admin: false},
  {email: "phathdt.leviateam@gmail.com", encrypted_password: "$2a$11$gh45Y4EKb.Zmb2qkuTeAp.t57xO0dlNfQhtjt3XNeYATe9OmFvMiW", reset_password_token: nil, reset_password_sent_at: nil, remember_created_at: nil, sign_in_count: 4, current_sign_in_at: "2017-07-19 04:07:05", last_sign_in_at: "2017-07-19 03:55:32", current_sign_in_ip: "127.0.0.1", last_sign_in_ip: "127.0.0.1", is_active: true, is_admin: false}
])
Album.create!([
  ...
  {user_id: 1, title: "hinh anh con meo", description: "3 con thu1 2", quality: 0, is_private: false, like_count: 0}
])
Picture.create!([
  ...
  {album_id: 11, title: nil, description: nil, is_private: false, like_count: 0, image_file_name: "cu.jpg", image_content_type: "image/jpeg", image_file_size: 7387, image_updated_at: "2017-07-19 03:23:07"},
  {album_id: 11, title: nil, description: nil, is_private: false, like_count: 0, image_file_name: "de.jpg", image_content_type: "image/jpeg", image_file_size: 9185, image_updated_at: "2017-07-19 03:23:07"},
  {album_id: 11, title: nil, description: nil, is_private: false, like_count: 0, image_file_name: "voi.jpg", image_content_type: "image/jpeg", image_file_size: 130279, image_updated_at: "2017-07-19 03:23:07"},
